...
[AuxVariables]
  ...
  [twin_slip_resistance_0]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_1]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_2]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_3]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_4]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_5]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_6]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_7]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_8]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_9]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_10]
    order = CONSTANT
    family = MONOMIAL
  []
  [twin_slip_resistance_11]
    order = CONSTANT
    family = MONOMIAL
  []
...
[]
 ...
 [cry_1]
  ...
  [twin_slip_resistance_0]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_0
  ...
  [twin_slip_resistance_1]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_1
   property = twin_slip_resistance
   index = 1
   execute_on = timestep_end
  []
  [twin_slip_resistance_2]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_2
   property = twin_slip_resistance
   index = 2
   execute_on = timestep_end
  []
  [twin_slip_resistance_3]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_3
   property = twin_slip_resistance
   index = 3
   execute_on = timestep_end
  []
  [twin_slip_resistance_4]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_4
   property = twin_slip_resistance
   index = 4
   execute_on = timestep_end
  []
  [twin_slip_resistance_5]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_5
   property = twin_slip_resistance
   index = 5
   execute_on = timestep_end
  []
  [twin_slip_resistance_6]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_6
   property = twin_slip_resistance
   index = 6
   execute_on = timestep_end
  []
  [twin_slip_resistance_7]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_7
   property = twin_slip_resistance
   index = 7
   execute_on = timestep_end
  []
  [twin_slip_resistance_8]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_8
   property = twin_slip_resistance
   index = 8
   execute_on = timestep_end
  []
  [twin_slip_resistance_9]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_9
   property = twin_slip_resistance
   index = 9
   execute_on = timestep_end
  []
  [twin_slip_resistance_10]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_10
   property = twin_slip_resistance
   index = 10
   execute_on = timestep_end
  []
  [twin_slip_resistance_11]
   type = MaterialStdVectorAux
   variable = twin_slip_resistance_11
   property = twin_slip_resistance
   index = 11
   execute_on = timestep_end
  []
...
[Materials]
  ...
  [twin_xtalpl]
    ...
    non_coplanar_coefficient_twin_hardening = 200
    initial_twin_lattice_friction = 80.0
    coplanar_coefficient_twin_hardening = 2700.0
  []
  [slip_xtalpl]
