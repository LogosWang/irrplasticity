...
RankTwoTensor initH(Real _number_of_loop,Real _amp,FileName _plane_file_name,RankTwoTensor crysrot, Real dl);
class CrystalPlasticityFccUpdate;
...
class CrystalPlasticityFccUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  CrystalPlasticityFccUpdate(const InputParameters & parameters);
...
protected:
  ...
  std::vector<RankTwoTensor> _H_shock_list;
  ...
  Real _T_critical;
  Real _theta;
  Real _loop_num_shock;
  Real _loop_num_frank;
  Real _amp;
  const Real _r;
  const Real _h;
  const Real _tau_sat;
  ...
  MaterialProperty<RankTwoTensor> & _H_shock;
  MaterialProperty<RankTwoTensor> & _H_frank;
  ...
  const MaterialProperty<RankTwoTensor> & _H_shock_old;
  ...
  RankTwoTensor _previous_substep_H_shock;
  /**
  ...
  RankTwoTensor _H_shock_before_update;
  /**
