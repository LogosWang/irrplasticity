...
/**
 * CrystalPlasticityTwinningUpdate uses the multiplicative decomposition
...
class CrystalPlasticityTwinningUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  CrystalPlasticityTwinningUpdate(const InputParameters & parameters);
