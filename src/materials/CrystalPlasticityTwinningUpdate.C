...
#include "CrystalPlasticityTwinningUpdate.h"
#include "libmesh/int_range.h"

registerMooseObject("irrplasticityApp", CrystalPlasticityTwinningUpdate);

InputParameters
CrystalPlasticityTwinningUpdate::validParams()
{
...
CrystalPlasticityTwinningUpdate::CrystalPlasticityTwinningUpdate(
...
{
  Real _theta=0.5*(1.0+std::tanh(_T/_T_critical));
}

void
CrystalPlasticityTwinningUpdate::initQpStatefulProperties()
{
...
void
CrystalPlasticityTwinningUpdate::setMaterialVectorSize()
{
...
void
CrystalPlasticityTwinningUpdate::setInitialConstitutiveVariableValues()
{
...
void
CrystalPlasticityTwinningUpdate::setSubstepConstitutiveVariableValues()
{
...
bool
CrystalPlasticityTwinningUpdate::calculateSlipRate()
{
...
void
CrystalPlasticityTwinningUpdate::calculateConstitutiveSlipDerivative(
...
bool
CrystalPlasticityTwinningUpdate::areConstitutiveStateVariablesConverged()
{
...
void
CrystalPlasticityTwinningUpdate::updateSubstepConstitutiveVariableValues()
{
...
void
CrystalPlasticityTwinningUpdate::cacheStateVariablesBeforeUpdate()
{
...
void
CrystalPlasticityTwinningUpdate::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
    _twin_volume_fraction_increment[_qp][i] =
        _slip_increment[_qp][i] / _characteristic_twin_shear;
}

bool
CrystalPlasticityTwinningUpdate::updateStateVariables()
{
...
bool
CrystalPlasticityTwinningUpdate::calculateTwinVolumeFraction()
{
...
void
CrystalPlasticityTwinningUpdate::calculateTwinResistance()
{
